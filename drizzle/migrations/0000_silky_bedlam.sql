...
CREATE TABLE "job_listing_applications" (
	...
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "job_listing_applications_jobLisitingId_userId_pk" PRIMARY KEY("jobLisitingId","userId")
);
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "job-listings" ADD CONSTRAINT "job-listings_organizationId_users_id_fk" FOREIGN KEY ("organizationId") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "job_listing_applications" ADD CONSTRAINT "job_listing_applications_jobLisitingId_job-listings_id_fk" FOREIGN KEY ("jobLisitingId") REFERENCES "public"."job-listings"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "organization_user_settings" ADD CONSTRAINT "organization_user_settings_organizationId_users_id_fk" FOREIGN KEY ("organizationId") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "user_resume" ADD CONSTRAINT "user_resume_userId_users_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
